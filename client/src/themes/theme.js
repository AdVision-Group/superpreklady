export const theme = {
  burgerButton: {
    ...
    primaryLight: "#f8f8f8",
    primaryHover: "#41178c",
    primaryTransparent: "rgba(255,255,255,0)",
    mobile: "576px",
  ...
  brakePoints: {
    ...
    mmw: "900px", // medium mobile width
    lmw: "900px", // large mobile width
    stw: "1300px", // small tablet width
    ltw: "1600px", // large tablet width
  },
  colors: {
    accentColor: "#3250d1",
    black: "#000000",
  ...
  fontSize: {
    menuFontSize: "15px",
    servicesFontSize: "15px",
    paragraphText: "18px",
    footerParagraphText: "15px",
    tableFontSize: "17px",
  ...
  header: {
    ...
    hamburgerIconColor: "#0B0E23",
  },
  fonts: {
    mainBlockHeadingFontSize: "25px",
